/*
  ...
  szablonu innymi niż typ oraz aliasów.

  Stworzymy szablon klasy symbolizującej wielkość fizyczną w jednostkach SI
  (czyli kombinacje różnych potęg kg, m oraz s). 
  Wielkości te można dodawać tylko jeśli ich jednostki są zgodne. 
  Czyli np. można dodać dwie liczby w m^2, ale nie można dodać np. m/s do m^2.
  ...
  nie tylko dla tych podanych w programie.

  Uwaga: kompilacja z flagami error musi skutkować błędem: 
  "no match for ‘operator+’ (operand types are (...)"
  
  Wskazówka: pojawi się pod koniec zajęć.
 */
