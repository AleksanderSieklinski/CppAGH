/* Celem zadania jest przećwiczenie dziedziczenia wielokrotnego,
  wirtualnych klas bazowych i dynamic_cast. 
  W tym celu stworzymy hierarchię klas reprezentujących różne 
  obiekty w grze.

  Proszę na podstawie wyniku wywnioskować, jaka jest hierarchia klas
  oraz dopisać niezbędne funkcje.
  Proszę trochę przemyśleć, które zmienne powinny być w klasie bazowej, 
  a które w kolejnych w hierarchii. 
