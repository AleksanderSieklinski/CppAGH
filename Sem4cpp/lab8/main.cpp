/*
 ...
 ze zwierzętami na łące (klasa Meadow). Są to różne zwierzęta:
 stworzymy klasy Sheep, Cow i Horse. Wszystkie zwierzęta mają imię,
 a ich destruktory wypisują podany komunikat. 

 Spośród zwierząt obecnych na łące tylko owce można strzyc. 
 To oznacza, że tylko klasa Sheep ma funkcję shear().
 Proszę dopisać niezbędne metody, tak by poniższy program
 działał poprawnie.

 Uwaga: Plik GeneralAnimal.h jest udostępniony na UPeLu. Nie należy go
 modyfikować.
 ...
 - można korzystać z dokumentacji, np. https://en.cppreference.com/w/cpp/container
   https://en.cppreference.com/w/cpp/memory oraz inne strony dokumentacji
 - Klasa Meadow po niczym nie dziedziczy
